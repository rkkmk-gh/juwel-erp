...
frappe.require("assets/erpnext/js/financial_statements.js", function () {
	frappe.query_reports["JG Profitability Report"] = {
		"filters": [
			{
				"fieldname": "company",
				"label": __("Company"),
		...
		"formatter": function (value, row, column, data, default_formatter) {
			if (column.fieldname == "account") {
				...
				column.link_onclick =
					"frappe.query_reports['JG Profitability Report'].open_profit_and_loss_statement(" + JSON.stringify(data) + ")";
				column.is_tree = true;
			}
	...
	erpnext.utils.add_dimensions('JG Profitability Report', 1);
